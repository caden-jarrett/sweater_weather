    ...
    describe 'happy path' do
        it 'send a current, daily, and hourly weather report' do
            ...
            forecast[:hourly_weather].each do |hw|
                ...
                expect(hw[:temperature]).to be_a Hash
                expect(hw[:temperature][:day]).to be_a Float
                expect(hw[:temperature][:min]).to be_a Float
                expect(hw[:temperature][:max]).to be_a Float
                expect(hw[:temperature][:night]).to be_a Float
                expect(hw[:temperature][:eve]).to be_a Float
                expect(hw[:temperature][:morn]).to be_a Float
